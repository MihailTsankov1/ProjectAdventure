Login page has to be fixed. Needs to change from login form to sign up form with a transition when clicking either "Dont have an account?" or "Already have an account"
